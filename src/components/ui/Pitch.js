...
const Pitch = ({
    ...
    return (
        <>
            <div className={cn} style={{backgroundImage: "url('assets/img/pitch.png')"}}>
                {/* <svg className='relative w-full' width="808" height="541" viewBox="0 0 808 541" fill="none" xmlns="http://www.w3.org/2000/svg">
